      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-8 text-left">
          ...
          <div className="rounded-2xl border border-[#E5E5DE] bg-white p-6 sm:p-8 shadow-sm">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-serif text-lg font-bold text-[#2D2D2D] mb-2">Our Location</h3>
          ...
          <div className="rounded-2xl border border-[#E5E5DE] bg-white p-6 sm:p-8 shadow-sm">
            <div className="flex gap-4">
              ...
              <div className="w-full">
                <h3 className="font-serif text-lg font-bold text-[#2D2D2D] mb-3">Hours of Operation</h3>
          ...
          <div className="rounded-2xl border border-[#E5E5DE] bg-white p-6 sm:p-8 shadow-sm">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-serif text-lg font-bold text-[#2D2D2D] mb-2">Direct Contact</h3>
        ...
        <div className="lg:col-span-7">
          <div className="rounded-2xl border border-[#E5E5DE] bg-white p-8 shadow-sm text-left">
            <h2 className="font-serif text-2xl font-bold text-[#2D2D2D] mb-2">Inquiry Form</h2>
            <p className="text-sm text-[#2D2D2D]/70 mb-8">
              Send us a message and our team will get back to you within 24 hours.
            </p>

            {isSubmitted ? (
              <div className="flex flex-col items-center justify-center py-12 text-center bg-[#FAFAF6] rounded-xl border border-[#E5E5DE] p-6 animate-fadeIn">
                <div className="h-14 w-14 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center mb-4">
                  <CheckCircle2 className="h-8 w-8" />
                </div>
                <h3 className="font-serif text-lg font-bold text-[#2D2D2D] mb-2">Message Sent Successfully</h3>
